(function(){
	...
	rgen.factory('Rest', ['Method', function(Method){
		var url_main = 'index.php?route=extension/module/rgen/rest&token='+rgen_config.token+'&parts=';
		...
		return {
			...
			getTypeahead       : function(type, val){ return Method.get('index.php?route=extension/module/rgen/autocomplete_'+type+'&token='+rgen_config.token+'&filter_name=' +  encodeURIComponent(val)); },

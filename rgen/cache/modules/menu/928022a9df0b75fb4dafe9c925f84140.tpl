...
<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/laser-x">Laser</a></li>
							...
							<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/primia">Primia</a></li>
	</ul>
<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/skinneed">Skinneed</a></li>
	</ul>
<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/保健系列">保健系列</a></li>
	</ul>
<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/果酸系列">果酸系列</a></li>
	</ul>
<ul class="mg-items cat-block1">
	<li class="hd"><a class="sub-item" href="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/特別護理">特別護理</a></li>
	</ul>
						</div>

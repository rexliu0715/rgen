<div id="rgen-gridmanager-rgenqas7Ow" class="rgen-gridmanager gridmanager-rgf9A">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-contentblocks-rgenLRZyk3" class="rgen-contentblocks contentblocks-rg5H1">
	<div class="mod-wrp container">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text">Mon - Sun / 9:00AM - 8:00PM</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenLRZyk3 .contentblock-grid', '#rgen-contentblocks-rgenLRZyk3 .contentblock-grid > .cl');
								});
								</script>
	...
	<div class="ctn-inner-wrp">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent condimentum ligula in felis blandit eleifend. Aliquam erat volutpat. Aenean tempor lectus ut augue bibendum consequat. Morbi vitae ex malesuada, laoreet sem eu, ullamcorper arcu. Fusce nunc erat, gravida et massa a, interdum congue eros. Sed in ornare nisl. Donec nec purus non elit maximus convallis. Vestibulum a gravida eros. Nulla ac lacus nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus</div>
								...
								<div id="rgen-imagegallery-rgenlN9oMa" class="rgen-imagegallery imagegallery-rgO2R" data-pswp-uid="1">
	<div class="mod-wrp container">
				...
				<div class="mod-content">
											<div class="rw gt20 mb20">
														<div class="cl cl12 d-xl12 t-xl12 m-xl12 m-sm12 m-xs12">
																								...
																								<div class="gallery-normalgrid-0 rw eq3 d-eq3 t-eq3 mxl-eq3 msm-eq3 mxs-eq3 gt10 mb10" id="grid-rgen-imagegallery-rgenlN9oMa_0" itemscope itemtype="http://schema.org/ImageGallery">
																											<div class="cl">
		...
		<figcaption>
				<h3 itemprop="caption">R.Gen - OpenCart Modern Store Design</h3>
						<p itemprop="description">R.Gen - OpenCart Modern Store Design</p>
								...
								<script>
								jQuery(document).ready(function($) {
									equalH('#rgen-imagegallery-rgenlN9oMa #grid-rgen-imagegallery-rgenlN9oMa_0', '#rgen-imagegallery-rgenlN9oMa #grid-rgen-imagegallery-rgenlN9oMa_0 > .cl');
								});
								</script>
...
$(document).ready(function() {
	photoSwipe_fn('#rgen-imagegallery-rgenlN9oMa');
});
</script>
							</div>
													</div>
										<script>
					$("#rgen-gridmanager-rgenqas7Ow").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgenqas7Ow").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgenqas7Ow .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgenqas7Ow .gridmanager-mod-content > .rw > .cl');
						});
					});

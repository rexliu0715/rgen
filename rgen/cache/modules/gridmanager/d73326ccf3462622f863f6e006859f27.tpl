<div id="rgen-gridmanager-rgenFmFHag" class="rgen-gridmanager gridmanager-rgf9A">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-contentblocks-rgenw3S4dw" class="rgen-contentblocks contentblocks-rg5H1">
	<div class="mod-wrp container">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text"><a href="mailto: mail@example.com">mail@example.com</a></div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenw3S4dw .contentblock-grid', '#rgen-contentblocks-rgenw3S4dw .contentblock-grid > .cl');
								});
								</script>
...
擁有獨特溶斑技術，真正的袪斑毛孔緊緻專家。</div>
								...
								<div id="rgen-imagegallery-rgenPVJBez" class="rgen-imagegallery imagegallery-rgO2R" data-pswp-uid="1">
	<div class="mod-wrp container">
				...
				<div class="mod-content">
											<div class="rw gt20 mb20">
														<div class="cl cl12 d-xl12 t-xl12 m-xl12 m-sm12 m-xs12">
																								...
																								<div class="gallery-normalgrid-0 rw eq3 d-eq3 t-eq3 mxl-eq3 msm-eq3 mxs-eq3 gt10 mb10" id="grid-rgen-imagegallery-rgenPVJBez_0" itemscope itemtype="http://schema.org/ImageGallery">
																											<div class="cl">
		...
		<figcaption>
				<h3 itemprop="caption">R.Gen - OpenCart Modern Store Design</h3>
						<p itemprop="description">R.Gen - OpenCart Modern Store Design</p>
								...
								<script>
								jQuery(document).ready(function($) {
									equalH('#rgen-imagegallery-rgenPVJBez #grid-rgen-imagegallery-rgenPVJBez_0', '#rgen-imagegallery-rgenPVJBez #grid-rgen-imagegallery-rgenPVJBez_0 > .cl');
								});
								</script>
...
$(document).ready(function() {
	photoSwipe_fn('#rgen-imagegallery-rgenPVJBez');
});
</script>
							</div>
													</div>
										<script>
					$("#rgen-gridmanager-rgenFmFHag").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgenFmFHag").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgenFmFHag .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgenFmFHag .gridmanager-mod-content > .rw > .cl');
						});
					});

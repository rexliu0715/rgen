<div id="rgen-gridmanager-rgen9ms3CT" class="rgen-gridmanager gridmanager-rgpFy">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-basicslideshow-rgenM73kGU" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenM73kGU > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenM73kGU .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenM73kGU .slideshow").sudoSlider({
		responsive: true,
...
//--></script>
								...
								<div id="rgen-productgroups-rgenFg9pWQ" class="rgen-productgroups productgroups-rgBhu">
	<div class="mod-wrp container">
	...
	<div class="rw gt40">
		...
		<div class="m-cl cl12 t-xl12">
			...
			<div class="mod-content">
								...
								<div 
					id            ="carousel-rgen-productgroups-rgenFg9pWQ_0"
	...
	<div class="info-wrp">
		...
		<div class="info">
			...
			<div class="buy-option">
				...
				<script type="text/javascript" ><!--
				$("#rgen-productgroups-rgenFg9pWQ #carousel-rgen-productgroups-rgenFg9pWQ_0").css({	opacity: 0 });
				$(document).ready(function() {
					var obj = "#rgen-productgroups-rgenFg9pWQ #carousel-rgen-productgroups-rgenFg9pWQ_0";
				...
				//--></script>
										...
										<script>
					$("#rgen-gridmanager-rgen9ms3CT").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgen9ms3CT").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgen9ms3CT .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgen9ms3CT .gridmanager-mod-content > .rw > .cl');
						});
					});

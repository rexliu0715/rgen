<div id="rgen-gridmanager-rgenhYh3Qx" class="rgen-gridmanager gridmanager-rgpFy">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-basicslideshow-rgenGr5uHs" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgenGr5uHs > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgenGr5uHs .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgenGr5uHs .slideshow").sudoSlider({
		responsive: true,
...
//--></script>
								...
								<div id="rgen-productgroups-rgencajlIu" class="rgen-productgroups productgroups-rgBhu">
	<div class="mod-wrp container">
	...
	<div class="rw gt40">
		...
		<div class="m-cl cl12 t-xl12">
			...
			<div class="mod-content">
								...
								<div 
					id            ="carousel-rgen-productgroups-rgencajlIu_0"
	...
	<div class="info-wrp">
		...
		<div class="info">
			...
			<div class="buy-option">
				...
				<script type="text/javascript" ><!--
				$("#rgen-productgroups-rgencajlIu #carousel-rgen-productgroups-rgencajlIu_0").css({	opacity: 0 });
				$(document).ready(function() {
					var obj = "#rgen-productgroups-rgencajlIu #carousel-rgen-productgroups-rgencajlIu_0";
				...
				//--></script>
										...
										<script>
					$("#rgen-gridmanager-rgenhYh3Qx").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgenhYh3Qx").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgenhYh3Qx .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgenhYh3Qx .gridmanager-mod-content > .rw > .cl');
						});
					});

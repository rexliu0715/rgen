<div id="rgen-gridmanager-rgenIhF2ZP" class="rgen-gridmanager gridmanager-rgpFy">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-basicslideshow-rgennKiSaX" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgennKiSaX > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgennKiSaX .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgennKiSaX .slideshow").sudoSlider({
		responsive: true,
...
//--></script>
								...
								<div id="rgen-productgroups-rgenr6IKN0" class="rgen-productgroups productgroups-rgBhu">
	<div class="mod-wrp container">
	...
	<div class="rw gt40">
		...
		<div class="m-cl cl12 t-xl12">
			...
			<div class="mod-content">
								...
								<div 
					id            ="carousel-rgen-productgroups-rgenr6IKN0_0"
	...
	<div class="info-wrp">
		...
		<div class="info">
			...
			<div class="buy-option">
				...
				<script type="text/javascript" ><!--
				$("#rgen-productgroups-rgenr6IKN0 #carousel-rgen-productgroups-rgenr6IKN0_0").css({	opacity: 0 });
				$(document).ready(function() {
					var obj = "#rgen-productgroups-rgenr6IKN0 #carousel-rgen-productgroups-rgenr6IKN0_0";
				...
				//--></script>
										...
										<script>
					$("#rgen-gridmanager-rgenIhF2ZP").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgenIhF2ZP").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgenIhF2ZP .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgenIhF2ZP .gridmanager-mod-content > .rw > .cl');
						});
					});

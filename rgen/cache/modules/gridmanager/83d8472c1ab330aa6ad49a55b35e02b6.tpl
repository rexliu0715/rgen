<div id="rgen-gridmanager-rgenen6kkD" class="rgen-gridmanager gridmanager-rgpFy">
		...
		<div class="gridmanager-mod-rw rw gt40">
			...
			<div class="m-cl cl12 t-xl12">
				<div class="mod-content gridmanager-mod-content">
								...
								<div id="rgen-basicslideshow-rgendSkpTY" class="rgen-basicslideshow basicslideshow-rgN0C">
	<div>
...
$(document).ready(function(){
		...
		$("#rgen-basicslideshow-rgendSkpTY > div").addClass('container');
	};
	
	var win         = $(window);
	var auto        = true;
	var autostopped = false;
	var container   = $("#rgen-basicslideshow-rgendSkpTY .slideshow-wrp");

	/* Default slide script
	------------------------*/
	var sudoSlider = $("#rgen-basicslideshow-rgendSkpTY .slideshow").sudoSlider({
		responsive: true,
...
//--></script>
								...
								<div id="rgen-productgroups-rgenMvBPCG" class="rgen-productgroups productgroups-rgBhu">
	<div class="mod-wrp container">
	...
	<div class="rw gt40">
		...
		<div class="m-cl cl12 t-xl12">
			...
			<div class="mod-content">
								...
								<div 
					id            ="carousel-rgen-productgroups-rgenMvBPCG_0"
	...
	<div class="info-wrp">
		...
		<div class="info">
			...
			<div class="buy-option">
				...
				<script type="text/javascript" ><!--
				$("#rgen-productgroups-rgenMvBPCG #carousel-rgen-productgroups-rgenMvBPCG_0").css({	opacity: 0 });
				$(document).ready(function() {
					var obj = "#rgen-productgroups-rgenMvBPCG #carousel-rgen-productgroups-rgenMvBPCG_0";
				...
				//--></script>
										...
										<script>
					$("#rgen-gridmanager-rgenen6kkD").css({opacity: 0});
					jQuery(document).ready(function($) {
						$("#rgen-gridmanager-rgenen6kkD").animate({opacity: 1}, 1000, function () {
							equalH('#rgen-gridmanager-rgenen6kkD .gridmanager-mod-content > .rw', '#rgen-gridmanager-rgenen6kkD .gridmanager-mod-content > .rw > .cl');
						});
					});

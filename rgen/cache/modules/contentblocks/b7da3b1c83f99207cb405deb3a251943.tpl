<div id="rgen-contentblocks-rgendBIPtY" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text">Mon - Sun / 9:00AM - 8:00PM</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgendBIPtY .contentblock-grid', '#rgen-contentblocks-rgendBIPtY .contentblock-grid > .cl');
								});
								</script>

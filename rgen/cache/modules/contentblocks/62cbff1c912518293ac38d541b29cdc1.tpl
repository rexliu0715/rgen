<div id="rgen-contentblocks-rgenIAz2YD" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenIAz2YD .contentblock-grid', '#rgen-contentblocks-rgenIAz2YD .contentblock-grid > .cl');
								});
								</script>

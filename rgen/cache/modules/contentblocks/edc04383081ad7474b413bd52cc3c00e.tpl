<div id="rgen-contentblocks-rgeng8EhFx" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text">Mon - Sun / 9:00AM - 8:00PM</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgeng8EhFx .contentblock-grid', '#rgen-contentblocks-rgeng8EhFx .contentblock-grid > .cl');
								});
								</script>

<div id="rgen-revslider-rgen7XQhf5" class="rgen-revslider revslider-rgrVA revo-fullwidth">
...
<ul>	<!-- SLIDE  -->
	<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-link="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/"  data-thumb="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/05.jpg"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="News">
		<!-- MAIN IMAGE -->
		<img src="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/system/config/revslider/images/dummy.png"  alt="05" data-lazyload="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/05.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
		...
		<div class="tp-caption sft rs-parallaxlevel-0"
			...
			style="z-index: 2;"><img src="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/system/config/revslider/images/dummy.png" alt="" data-lazyload="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/1580312_demo06-slide1-text1.png">
		</div>
	...
	<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-link="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/"  data-target="_blank" data-thumb="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/07.jpg"  data-saveperformance="off"  data-title="Slide 2">
		<!-- MAIN IMAGE -->
		<img src="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/system/config/revslider/images/dummy.png"  alt="07" data-lazyload="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/07.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
	...
	<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-link="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/"  data-target="_blank" data-thumb="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/02.jpg"  data-saveperformance="off"  data-title="Slide 3">
		<!-- MAIN IMAGE -->
		<img src="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/system/config/revslider/images/dummy.png"  alt="02" data-lazyload="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/02.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
		<!-- LAYERS -->
		...
		<div class="tp-caption randomrotate rs-parallaxlevel-0"
			...
			style="z-index: 2;"><img src="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/system/config/revslider/images/dummy.png" alt="" data-lazyload="http://ec2-52-76-172-22.ap-southeast-1.compute.amazonaws.com/image/catalog/revslider_media_folder/4387317_demo06-slide2-circle.png">
		</div>

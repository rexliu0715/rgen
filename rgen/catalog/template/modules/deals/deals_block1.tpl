...
<div class="deals-box deals-box1<?php echo ' '.$block['img_position'].$blockClass; ?>" id="<?php echo $pdid; ?>">
	...
	if ($block['img_position'] == 't') {
		include $rgen_config->deals_block1_img;
		include $rgen_config->deals_block1_info;
	}

	if ($block['img_position'] == 'l' || $block['img_position'] == 'r') { ?>
	<div class="tbl-gr eq2<?php echo $valign; ?>">
		<?php if ($block['img_position'] == 'l') { include $rgen_config->deals_block1_img; } ?>
		<?php include $rgen_config->deals_block1_info; ?>
		<?php if ($block['img_position'] == 'r') { include $rgen_config->deals_block1_img; } ?>
	</div>
	<?php } ?>

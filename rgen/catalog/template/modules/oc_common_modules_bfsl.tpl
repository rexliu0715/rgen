...
$colpos = false;
if (isset($rgen_config->rgenSettings->st_data['current_pos'])) {
	if ($rgen_config->rgenSettings->st_data['current_pos'] == 'column_left' || 
		$rgen_config->rgenSettings->st_data['current_pos'] == 'column_right') {
		$colpos = true;
	}
} ?>
...
<div class="mod-content">
	...
	/* Carousel view
	------------------------*/
	foreach ($products as $product) { include $rgen_config->{'smallprd'.$clp}; }

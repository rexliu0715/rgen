...
if (!$quickview) { include $rgen_config->layout_top; }
...
**************************/
if ($quickview) { 
	include $rgen_config->prd_quickview; 
} else {
...
<div class="product-info product-info1">
	<div class="rw-wrp rw <?php echo $ly1_gt; ?>">
		<div class="l-wrp cl<?php echo $ly1_l; ?>">
			<div class="prdinfo-left">
				<?php include $rgen_config->prd_image; ?>
			</div>
		</div>
			...
			<div class="prdinfo-right">
				...
				**************************/ ?>
				...
				<div class="product-options-wrp" id="product">
					<section class="l"><div class="m-data buying-info"></div><?php include $rgen_config->prd_options; ?></section>
					<section class="r">
						<?php include $rgen_config->prd_buyinginfo; ?>
						<?php 
	...
	<?php 
	include $rgen_config->prd_tabs; 
	include $rgen_config->prd_tags;
	?>
</div>
<?php } ?>
		...
		<div class="r-wrp cl<?php echo $ly3_r; ?>">
			<div class="prdinfo-right">
				...
				**************************/ ?>
				...
				<div class="product-options-wrp" id="product">
					<?php include $rgen_config->prd_buyinginfo2; ?>
					<?php include $rgen_config->prd_tabs1; ?>
				</div>
			</div>
		</div>
	</div>
...
<?php
	include $rgen_config->prd_related;

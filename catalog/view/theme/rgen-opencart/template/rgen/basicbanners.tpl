...
$modid        = 'rgen-basicbanners-'.$rgen_config->factory->uid();
	...
	<div class="mod-wrp<?php echo $container; ?>">
		...
		<div class="mod-content">
			...
			<div class="rw <?php echo $settings['grids']['classGroup']; ?>">
				...
				<div class="cl">
					<?php include $rgen_config->basicbanners_data; ?>
				</div>
				<?php } } ?>
			</div>
			<?php } else {
			...
			$(document).ready(function() {
				...
				var resObj = { <?php echo $rgen_config->factory->scrollItems($settings['carousel']['display_items']); ?>	};

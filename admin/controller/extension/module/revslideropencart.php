...
// end language
		...
		$data['action'] = $this->url->link('extension/module/revslideropencart', 'token=' . $this->session->data['token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

		/*R.Gen changes*/
		$data['backto_rgen'] = $this->url->link('module/rgen', 'token=' . $this->session->data['token'] . '#/module/revslider/manage', true);
		/*=============*/
